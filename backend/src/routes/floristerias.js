...
const storage = multer.diskStorage({
  destination: function (req, file, cb) {
    const uploadPath = path.join(__dirname, '../../uploads/floristerias');
...
// Rutas
router.get('/', auth, floristeriasController.obtenerFlores);
router.get('/:id', auth, floristeriasController.obtenerFlorPorId);

router.post('/', auth, isAdmin, handleUpload, floristeriasController.crearFlor);
router.put('/:id', auth, isAdmin, handleUpload, floristeriasController.actualizarFlor);
router.delete('/:id', auth, isAdmin, floristeriasController.eliminarFlor);
